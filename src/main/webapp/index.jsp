...
<ol>
    <li>Start <a href="https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop">Postman</a>
        or any similar API testing tools.
    </li>
    ...
    <li>Send POST request to /url-shortener/register with following body content: {"url":"SomeLongUrl"} and header
        "Authorization: password" (using password from the previous step)
    </li>
    ...
    <li>To get statistics, send GET request to /url-shortener/statistic/SomeName (accountId used when creating account),
        response will be json array with registered urls and numbers of visits
    </li>
</ol>
</body>
</html>
